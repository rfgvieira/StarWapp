...
import com.example.activitystarwapp.presentation.viewmodel.TodosViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tabLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            override fun onTabSelected(tab: TabLayout.Tab?) {
                ...
                when (tab?.id) {
                    0 -> {
                        binding.tvSubtitle.setText(R.string.personagens)
                    ...
                    1 -> {
                        binding.tvSubtitle.setText(R.string.planetas)
                    ...
                    2 -> {
                        binding.tvSubtitle.setText(R.string.espaconaves)
